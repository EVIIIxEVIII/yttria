...
Instance::Instance() {
    ...
    appInfo.pApplicationName = "Dev application";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "Yttria engine";
...
std::vector<const char*> Instance::getRequiredExtensions() {
    ...
    // the line below takes a pointer to the first glfwExtension and a pointer to one past the last extension
    // in order to construct a vector array out of them
