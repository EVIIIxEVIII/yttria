...
public:
    ...
    bool compareSwapFormats(const SwapChain& swapChain_) const {
        return swapChain_.swapChainDepthFormat_ == swapChainDepthFormat_ &&
               swapChain_.swapChainImageFormat_ == swapChainImageFormat_;
    };
